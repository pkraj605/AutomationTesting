...
public class EventCreate extends Superclass{
	...
	public static void main(String[] args) throws InterruptedException {
		...
		//click on Create Event
				...
				//Put The event Name
				driver.findElement(By.xpath("/html/body/div[1]/div[2]/div/main/div/div/div[2]/div/div[2]/div/form/div[1]/div[2]/div/div[1]/div/div/input")).sendKeys("Independence Day Event");
				Thread.sleep(2000);
	...
	//click on host dropdown
				...
				//select offline mode
				driver.findElement(By.xpath("/html/body/div[1]/div[2]/div/main/div/div/div[2]/div/div[2]/div/form/div[7]/div[2]/div/div/div/label[2]/span[1]/input")).click();
				Thread.sleep(2000);
				
				//Enter address
				driver.findElement(By.xpath("/html/body/div[1]/div[2]/div/main/div/div/div[2]/div/div[2]/div/form/div[8]/div[2]/div/div[1]/div/div/input")).sendKeys("Mumbai");
				Thread.sleep(2000);
				
				//select free mode
				driver.findElement(By.xpath("/html/body/div[1]/div[2]/div/main/div/div/div[2]/div/div[2]/div/form/div[9]/div[4]/label/span[1]/input")).click();
				Thread.sleep(3000);
					
		//Select start date
				
				driver.findElement(By.xpath("/html/body/div[1]/div[2]/div/main/div/div/div[2]/div/div[2]/div/form/div[10]/div[2]/div/div/div/div/button")).click();
				Thread.sleep(2000);
				driver.findElement(By.xpath("/html/body/div[3]/div[2]/div[1]/div/div/div[1]/div[2]/button[2]")).click();
				Thread.sleep(2000);
				driver.findElement(By.xpath("/html/body/div[3]/div[2]/div[1]/div/div/div[2]/div/div[2]/div/div[2]/div[2]/button")).click();
				Thread.sleep(2000);
		...
		//Select end date
				...
				//Enter start time
				WebElement etime=driver.findElement(By.xpath("/html/body/div[1]/div[2]/div/main/div/div/div[2]/div/div[2]/div/form/div[10]/div[4]/div/div/div/input"));
