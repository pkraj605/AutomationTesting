...
public class ArticleLike extends Superclass{
	...
	public static void main(String[] args) throws InterruptedException {
		...
		//Article Like
		driver.findElement(By.xpath("/html/body/div[1]/div[2]/div/main/div/div[2]/div/div/div[1]/div/div[4]/div/div[1]/div/button")).click();
		Thread.sleep(2000);
