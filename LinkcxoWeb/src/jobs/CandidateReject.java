...
public class CandidateReject extends Superclass {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		//click on job Module
				...
				//click on candidate>>Reject
				driver.findElement(By.xpath("/html/body/div[1]/div[2]/div/main/div/div[1]/div[2]/div[2]/div/div/div/div/div[3]/div/div[3]/button")).click();
				Thread.sleep(4000);
