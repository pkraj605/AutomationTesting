...
public class PostShare extends Superclass{
	...
	public static void main(String[] args) throws InterruptedException {
		...
		//post share
		driver.findElement(By.xpath("/html/body/div[1]/div[2]/div/main/div/div[2]/div/div/div[1]/div/div[3]/div/div[3]/div/button")).click();
		Thread.sleep(3000);

		driver.findElement(By.xpath("/html/body/div[1]/div[2]/div/div/div/div[2]/div/div/textarea[1]")).sendKeys("post share");
		Thread.sleep(3000);
